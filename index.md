...
6. L. Shao, **F. Ferreira\***, M. Jorda\*, V. Nambiar*, J. Luo, E. Solowjow, J. A. Ojea, O. Khatib, J. Bohg: MetaGrasp: Learning to Grasp with N-Fingered Robotic Hands, submitted to Robotics and Automation Letters (RA-L) 2020
5. **F. Ferreira\***, J. Rothfuss\*, S. Walther, M. Ulrich: [Conditional Density Estimation with Neural Networks: Best Practices and Benchmarks](https://arxiv.org/abs/1903.00954), to be submitted, [[code](https://github.com/freelunchtheorem/Conditional_Density_Estimation/), [documentation](https://jonasrothfuss.github.io/Conditional_Density_Estimation)]
